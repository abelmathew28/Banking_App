...
if($_POST) {
	...
	$sql = "INSERT INTO login (username, passcode, usertype, status) VALUES ('$username', '$password', '$user', '$status')";
	 ...
	 $login_id = $connect->insert_id;
		...
		$data = $accresult->fetch_assoc();
			...
			if($connect->query($account_holders) === TRUE) {
				...
				$account_holders_details = "INSERT INTO holders_detail (holder_id,account_number, account_type,IFSC_code,security_question_id,answer,initial_deposit,current_balance,last_transaction_date, last_transaction_amount) VALUES ('$account_holderid','$bank_account_number', '$account_type', 'ABM000123','$security_question', '$answer', 0,0, '$date', 0)";
